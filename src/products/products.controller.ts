...
export class ProductsController {
  ...
  @ApiResponse({ status: 200, description: 'List of all products successfully retrieved ( assigned catalogs are not included )', type: [ProductEntity] })
  @Get()
  ...
  @ApiResponse({ status: 200, description: 'Product successfully retrieved', type: ProductEntity })
  ...
  @ApiResponse({ status: 200, description: 'Product successfully updated', type: ProductEntity })
  @ApiNotFoundResponse({ description: 'Product not found' })
  ...
  @ApiResponse({ status: 200, description: 'Product successfully deleted', type: ProductEntity })
  @ApiNotFoundResponse({ description: 'Product not found' })
  @Delete(':id')
  async deleteProduct(
    @Param('id', ParseIntPipe) id: number,
  ...
  @ApiParam({ name: 'id', description: 'The ID of the product', type: 'number' })
  @ApiParam({ name: 'catalogId', description: 'The ID of the catalog to link', type: 'number' })
  @ApiResponse({ status: 201, description: 'Product successfully assigned to catalog', type: ProductEntity })
  ...
  @ApiParam({ name: 'id', description: 'The ID of the product', type: 'number' })
  @ApiParam({ name: 'catalogId', description: 'The ID of the catalog to disconnect from', type: 'number' })
  @ApiResponse({ status: 200, description: 'Product successfully removed from catalog', type: ProductEntity })
  @ApiNotFoundResponse({ description: 'Product or Catalog not found, or not currently linked' })
